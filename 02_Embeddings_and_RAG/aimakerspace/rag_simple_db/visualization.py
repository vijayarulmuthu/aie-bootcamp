...
class RAGVisualizer:
    def __init__(self, db_path: str = "rag_simple_db/results/results.db"):
    ...
    def _validate_db(self):
        ...
        try:
            ...
            cursor = conn.cursor()
            cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='rag_results_simple_db'")
            if not cursor.fetchone():
                raise ValueError("Database does not contain required 'rag_results_simple_db' table")
            conn.close()
    ...
    def visualize_query_results(self, output_dir: str = "rag_simple_db/results") -> str:
        """
